...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../uart_module.sopcinfo
...
# Design Name 
# setting SOPC_NAME is uart_module
SOPC_NAME := uart_module
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1041040
SOPC_SYSID_FLAG += --sidp=0x1041040
ELF_PATCH_FLAG  += --sidp 0x1041040

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1704790922
SOPC_SYSID_FLAG += --timestamp=1704790922
ELF_PATCH_FLAG  += --timestamp 1704790922
