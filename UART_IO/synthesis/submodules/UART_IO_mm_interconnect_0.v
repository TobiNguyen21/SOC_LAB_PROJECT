...
`timescale 1 ps / 1 ps
module UART_IO_mm_interconnect_0 (
	...
	wire   [5:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire   [5:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire  [95:0] cmd_mux_001_src_data;                                                             // cmd_mux_001:src_data -> nios2_qsys_debug_mem_slave_agent:cp_data
	...
	wire  [19:0] pio_switch_s1_agent_m0_address;                                                   // pio_switch_s1_agent:m0_address -> pio_switch_s1_translator:uav_address
	...
	wire  [96:0] pio_switch_s1_agent_rf_source_data;                                               // pio_switch_s1_agent:rf_source_data -> pio_switch_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] pio_switch_s1_agent_rsp_fifo_out_data;                                            // pio_switch_s1_agent_rsp_fifo:out_data -> pio_switch_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                            // cmd_mux_004:src_valid -> pio_switch_s1_agent:cp_valid
	wire  [95:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> pio_switch_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                            // pio_switch_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> pio_switch_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                    // cmd_mux_004:src_startofpacket -> pio_switch_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                      // cmd_mux_004:src_endofpacket -> pio_switch_s1_agent:cp_endofpacket
	...
	wire  [95:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> pio_button_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                            // pio_button_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> pio_button_s1_agent:cp_channel
	...
	wire  [95:0] nios2_qsys_debug_mem_slave_agent_rp_data;                                         // nios2_qsys_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [95:0] pio_switch_s1_agent_rp_data;                                                      // pio_switch_s1_agent:rp_data -> router_006:sink_data
	...
	wire         pio_button_s1_agent_rp_valid;                                                     // pio_button_s1_agent:rp_valid -> router_007:sink_valid
	wire  [95:0] pio_button_s1_agent_rp_data;                                                      // pio_button_s1_agent:rp_data -> router_007:sink_data
	wire         pio_button_s1_agent_rp_ready;                                                     // router_007:sink_ready -> pio_button_s1_agent:rp_ready
	wire         pio_button_s1_agent_rp_startofpacket;                                             // pio_button_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         pio_button_s1_agent_rp_endofpacket;                                               // pio_button_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         pio_switch_s1_agent_rdata_fifo_src_valid;                                         // pio_switch_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_switch_s1_agent_rdata_fifo_src_data;                                          // pio_switch_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_switch_s1_agent_rdata_fifo_src_ready;                                         // avalon_st_adapter_004:in_0_ready -> pio_switch_s1_agent:rdata_fifo_src_ready
	...
	UART_IO_mm_interconnect_0_router router (
	...
	UART_IO_mm_interconnect_0_router_001 router_001 (
	...
	UART_IO_mm_interconnect_0_router_002 router_002 (
	...
	UART_IO_mm_interconnect_0_router_003 router_003 (
	...
	UART_IO_mm_interconnect_0_router_003 router_004 (
	...
	UART_IO_mm_interconnect_0_router_002 router_005 (
	...
	UART_IO_mm_interconnect_0_router_002 router_006 (
	...
	UART_IO_mm_interconnect_0_router_002 router_007 (
	...
	UART_IO_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (pll_sys_outclk0_clk),                          //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (pll_sys_outclk0_clk),                          //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (pll_sys_outclk0_clk),                         //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (pll_sys_outclk0_clk),                          //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (pll_sys_outclk0_clk),                         //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (pll_sys_outclk0_clk),                         //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (pll_sys_outclk0_clk),                         //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (pll_sys_outclk0_clk),                         //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (pll_sys_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (pll_sys_outclk0_clk),                          //       clk.clk
		.reset              (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (pll_sys_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (pll_sys_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (pll_sys_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (pll_sys_outclk0_clk),                         //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (pll_sys_outclk0_clk),                          //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (pll_sys_outclk0_clk),                          //       clk.clk
		.reset               (nios2_qsys_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	UART_IO_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
