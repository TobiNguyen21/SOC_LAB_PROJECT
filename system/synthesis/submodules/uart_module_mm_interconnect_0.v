// uart_module_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module uart_module_mm_interconnect_0 (
	...
	wire  [100:0] rsp_mux_src_data;                                                                 // rsp_mux:src_data -> nios2_gen2_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                // nios2_gen2_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [7:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_gen2_data_master_agent:rp_channel
	...
	wire  [100:0] rsp_mux_001_src_data;                                                             // rsp_mux_001:src_data -> nios2_gen2_instruction_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                            // nios2_gen2_instruction_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [7:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_gen2_instruction_master_agent:rp_channel
	...
	wire  [100:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> nios2_gen2_debug_mem_slave_agent:cp_data
	...
	wire  [101:0] uart_s1_agent_rf_source_data;                                                     // uart_s1_agent:rf_source_data -> uart_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] uart_s1_agent_rsp_fifo_out_data;                                                  // uart_s1_agent_rsp_fifo:out_data -> uart_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_004_src_data;                                                             // cmd_mux_004:src_data -> uart_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                            // uart_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> uart_s1_agent:cp_channel
	...
	wire  [101:0] switch_s1_agent_rf_source_data;                                                   // switch_s1_agent:rf_source_data -> switch_s1_agent_rsp_fifo:in_data
	...
	wire  [101:0] switch_s1_agent_rsp_fifo_out_data;                                                // switch_s1_agent_rsp_fifo:out_data -> switch_s1_agent:rf_sink_data
	...
	wire  [100:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> switch_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                            // switch_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [100:0] nios2_gen2_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [100:0] uart_s1_agent_rp_data;                                                            // uart_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [100:0] switch_s1_agent_rp_data;                                                          // switch_s1_agent:rp_data -> router_007:sink_data
	...
	uart_module_mm_interconnect_0_router router (
	...
	uart_module_mm_interconnect_0_router_001 router_001 (
	...
	uart_module_mm_interconnect_0_router_002 router_002 (
	...
	uart_module_mm_interconnect_0_router_002 router_003 (
	...
	uart_module_mm_interconnect_0_router_004 router_004 (
	...
	uart_module_mm_interconnect_0_router_004 router_005 (
	...
	uart_module_mm_interconnect_0_router_002 router_006 (
	...
	uart_module_mm_interconnect_0_router_002 router_007 (
	...
	uart_module_mm_interconnect_0_router_002 router_008 (
	...
	uart_module_mm_interconnect_0_router_009 router_009 (
	...
	uart_module_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_cmd_mux_002 cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                               //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                               //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_demux_002 rsp_demux_007 (
		.clk                (clk_0_clk_clk),                                //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	uart_module_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
